...
class HeadphonesPage extends StatefulWidget{
  _HeadphonesPageState createState() =>  _HeadphonesPageState();
}
                  ...
                  Padding(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) => InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => ProductPage(item:headphones[index])));
                          },
                          child: buildCard(headphones[index])),
                    ),
                  ),
                  SizedBox(height: 20,),
